...
IMG ?= coffeenights/conure-controller:latest
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=manager-role crd webhook paths="./apis/..." paths="./internal/..." paths="./cmd/control/..." output:crd:artifacts:config=config/crd/bases
