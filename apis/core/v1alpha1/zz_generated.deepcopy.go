...
func (in *ComponentDefinitionSpec) DeepCopyInto(out *ComponentDefinitionSpec) {
	*out = *in
	...
	if in.Helm != nil {
		...
		*out = new(HelmEngineSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.FieldRoles != nil {
		in, out := &in.FieldRoles, &out.FieldRoles
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HelmEngineSpec) DeepCopyInto(out *HelmEngineSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HelmEngineSpec.
func (in *HelmEngineSpec) DeepCopy() *HelmEngineSpec {
	if in == nil {
		return nil
	}
	out := new(HelmEngineSpec)
