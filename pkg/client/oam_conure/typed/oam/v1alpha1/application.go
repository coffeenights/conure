...
import (
	...
	v1alpha1 "github.com/coffeenights/conure/api/oam/v1alpha1"
	scheme "github.com/coffeenights/conure/pkg/client/oam_conure/scheme"
...
func newApplications(c *OamV1alpha1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
