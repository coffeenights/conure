...
func GenerateRoutes(relativePath string, r *gin.Engine, appHandler *ApiHandler) {
	applications := r.Group(relativePath, middlewares.CheckAuthenticatedUser(appHandler.Config, appHandler.MongoDB))
	{
		...
		applications.GET("/:organizationID/component-definitions", appHandler.ListComponentDefinitions)
		applications.POST("/:organizationID/component-definitions", appHandler.CreateComponentDefinition)
		applications.POST("/:organizationID/component-definitions/hide", appHandler.HideComponentDefinition)
		applications.DELETE("/:organizationID/component-definitions/:definitionID", appHandler.DeleteComponentDefinition)
