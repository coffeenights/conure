...
func (v *Variable) ListByOrg(mongo *database.MongoDB, client, organizationID string) ([]Variable, error) {
	collection := mongo.Client.Database(mongo.DBName).Collection(VariableCollection)
...
func (v *Variable) ListByEnv(mongo *database.MongoDB, client, organizationID, applicationID,
	environmentID string) ([]Variable, error) {
	collection := mongo.Client.Database(mongo.DBName).Collection(VariableCollection)
	findOptions := options.Find()
	findOptions.SetSort(bson.D{{"name", 1}})
	cursor, err := collection.Find(context.Background(), primitive.M{"client": client,
...
func (v *Variable) ListByComp(mongo *database.MongoDB, client, organizationID, applicationID,
	environmentID, componentID string) ([]Variable, error) {
	collection := mongo.Client.Database(mongo.DBName).Collection(VariableCollection)
	findOptions := options.Find()
	findOptions.SetSort(bson.D{{"name", 1}})
	cursor, err := collection.Find(context.Background(), primitive.M{"client": client,
...
func (v *Variable) GetByOrgAndName(mongo *database.MongoDB, client string, organizationID string, name string) error {
	collection := mongo.Client.Database(mongo.DBName).Collection(VariableCollection)
...
func (v *Variable) GetByAppIDAndEnvAndName(mongo *database.MongoDB, client string, applicationID string, t VariableType,
	environmentID *string, name string) error {
	collection := mongo.Client.Database(mongo.DBName).Collection(VariableCollection)
...
func (v *Variable) GetByAppIDAndEnvAndCompAndName(mongo *database.MongoDB, client string, applicationID string, t VariableType,
	environmentID *string, componentID *string, name string) error {
	collection := mongo.Client.Database(mongo.DBName).Collection(VariableCollection)
	err := collection.FindOne(context.Background(), primitive.M{"client": client, "applicationId": applicationID,
