...
require (
	...
	github.com/stefanprodan/timoni v0.23.0
...
replace github.com/stefanprodan/timoni v0.23.0 => github.com/coffeenights/timoni v0.23.1-0.20250118073647-acadeec5e24b
