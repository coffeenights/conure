...
A [timoni.sh](http://timoni.sh) module for deploying webservice to Kubernetes clusters.
...
```shell
timoni -n default apply webservice oci://<container-registry-url>
```
...
```shell
timoni -n default delete webservice
```
